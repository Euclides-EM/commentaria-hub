...
DEDUCTIVE = DERIVED / "deductive_parts.csv"
...
def main() -> None:
    ...
    pd.DataFrame(corpus_rows).to_csv(TABLES / "corpus_accounting.csv", index=False)
    ...
    subject_social_matrix.to_csv(TABLES / "subject_social_rates_matrix.csv")
    save_heatmap(
    ...
    subject_int_matrix.to_csv(TABLES / "subject_intellectual_rates_matrix.csv")
    save_heatmap(
        subject_int_matrix,
    ...
    contrast.to_csv(TABLES / "elements_vs_non_elements_core_contrasts.csv", index=False)
    ...
    mode_matrix.to_csv(TABLES / "elements_mode_marker_rates_matrix.csv")
    save_heatmap(
        mode_matrix,
    ...
    book_matrix.to_csv(TABLES / "elements_book_group_marker_rates_matrix.csv")
    save_heatmap(
        book_matrix,
        FIGURES / "heatmap_elements_book_group_marker_rates.png",
    ...
    deductive_corpus_matrix.to_csv(TABLES / "deductive_parts_by_corpus_matrix.csv")
    save_heatmap(
    ...
    deductive_book_matrix.to_csv(TABLES / "deductive_parts_by_book_group_matrix.csv")
    save_heatmap(
