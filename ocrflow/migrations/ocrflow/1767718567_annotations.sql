...
VALUES
    ...
    ('4s48pk',
     '4s48pk',
     'Inferred annotations from Kraken on the same pages as above',
     CURRENT_TIMESTAMP,
     CURRENT_TIMESTAMP,
     '15-655',
     1,
    ...
    ('ucxw7g',
     'ucxw7g',
     'Inferred annotations from the 1615FineTunedCapricciosaM_0312 model without subtypes of the main zone (except headers). Based on the YALTAi model (CapricciosaM) after it was fine tuned on manually annotated data (id=f0k3ks). The manual annotations included subtypes like paragraphs and enunciations.',
     CURRENT_TIMESTAMP,
     CURRENT_TIMESTAMP,
     '15-320,388-655',
     1,
    ...
    ('7plb84',
     '7plb84',
     'Same as ucxw7g, after transcribing with the 1615FineTunedGallicorpor_0301.mlmodel OCR model.',
     CURRENT_TIMESTAMP,
     CURRENT_TIMESTAMP,
     '15-320,388-655',
     1,
