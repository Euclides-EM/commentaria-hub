...
*[Figure: three figures of two unequal similar segments upon the same base a b, the apexes marked c and d; in the third the line b d cuts a c and the smaller circumference in e]*
...
*[Figure: two segments upon the base α β, the outer with apex δ, the inner with γ; the lines α γ δ, γ β and δ β are drawn]*
...
*[Figure: two equal segments, the one with apex e upon the base a b, the other with apex f upon the base c d]*
...
*[Figure: segment with apex ε upon the base α β; below it a segment upon the base γ δ with the apexes ζ and η, the one arc differing from the other]*
