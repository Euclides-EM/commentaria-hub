...
*[Figure: a circle with apex a at top, points c and b at the base, centre d, with lines from a to c and b and from d to c and b]*
...
*[Figure: a semicircle described over c d intersecting a smaller circle at a point; labels c, e, d, b]*
...
Extra enim circulũ positiõe datũ a b c assumatur signũ aliquod d, ab ipso aũt d signo extẽdatur recta linea d b secãs circulũ. Dico q̃ quod sub b d, d c datũ est, excitetur enim ab ipso d signo ipsum a b c, circulũ tãgẽs, recta linea d a per 17 tertij ele. Data igitur est d a positiõe & magnitudie. *[sic: "magnitudie" for "magnitudine"]* Q̃m igitur data est a d, datũ igitur est & quod ex a d, & est æquale ei quod sub b d, d c, per 36 tertij el. Datũ igitur est quod sub b d, d c.
...
*[Figure: a circle with labels b (top), a (left), c (interior right), and external point d below with lines drawn to the circle; below it a second circle with labels f, c, e, b, a and tangent and secant lines from d]*
