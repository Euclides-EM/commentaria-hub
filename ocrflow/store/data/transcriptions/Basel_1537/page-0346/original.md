...
*[Figure: a rectangle divided by a horizontal line into an upper part b and a lower part a]*
...
*[Figure: rectangle β γ divided by a vertical line ε δ: β above the top-left corner, ε above the top of the dividing line, α(?) below the bottom-left corner, δ below the bottom of the dividing line, γ below the bottom-right corner]*
