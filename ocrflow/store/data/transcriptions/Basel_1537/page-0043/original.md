...
*[Figure: parallelogram α β γ δ with triangle ε β γ on the same base between the same parallels, diagonal α γ drawn]*

## Eucli. ex Camp. Propositio 42.

*[Margin: 42]*

Equidistantiū laterum superficiem designare, cuius angulus sit angulo assignato æqualis, ipsa uero superficies triangulo assignato æqualis.
...
*[Figure: triangle b c d with midpoint e of base c d, line b e, line b f parallel to c d, and parallelogram g e d f; the given angle a shown separately to the right]*
...
*[Figure: triangle α β γ with ε the midpoint of β γ, parallelogram ζ ε γ η between the same parallels; the given angle δ shown separately]*

## Eucli. ex Camp. Propositio 43.

*[Margin: 43]*

Mnis parallelogrāmi spatij, eorum quæ circa diametrū sunt parallelogrammorū supplementa, æqua sibi inuicē esse necesse est.
