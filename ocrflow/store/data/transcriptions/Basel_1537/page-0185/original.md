...
*[Figure: numbers as dot-rows: α (20 dots), β (14 dots), γ (9 dots), δ (8 dots), ε (2 dots), ζ (3 dots)]*
...
**4** OMnium duorum numerorū inæqualium, minor, maioris aut pars est, aut partes.

*[Woodcut initial O with a face within a square frame]*
...
*[Figure: numbers as dot-rows: a (8 dots), b (4 dots), b (6 dots), b (7 dots)]*
...
*[Figure: numbers as dot-rows: α (13 dots); β—γ (8 dots); β—γ (7 dots); β—γ (10 dots with interior points ε and ζ); δ (3 dots)]*

## Eucli. ex Camp. Propositio 5

**5** SI fuerint quatuor numeri, quorum primus tota pars secundi quota tertius quarti, erunt primus & tertius pariter accepti tota pars secundi & quarti pariter acceptorum, quota primus secundi.
...
*[Figure: numbers as dot-rows: a (8 dots) with c (6 dots); b (4 dots) with d (3 dots)]*
