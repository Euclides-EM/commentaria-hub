...
*[Figure: square with c and a at the top, k and h at the sides, d, e, b, f along the bottom, g at the right; a diagonal line runs from a down to e]*
...
*[Figure: square α β γ δ with a smaller square on α ζ adjoined above, points ε, ζ, η, θ, κ marking the construction; a diagonal line runs across the figure]*
