...
*[Figure, right: a dotted line labelled ζ, θ, ε (two groups of dots); below it a dotted line labelled η; beneath, a square with corners α (top left), β (top right), δ (bottom left), γ (bottom right) and the diagonal drawn from α to γ]*
