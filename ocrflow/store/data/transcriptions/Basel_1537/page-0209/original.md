...
*[Figure: five dotted number lines beside the text, labelled l, m, n, p, q, of decreasing length]*
...
*[Figure: dotted number lines beside the text: f (longest); e; then in one row c, b, a (short) with "unitas" and a single dot below; then g, h, K, l of decreasing length]*

## Propositis partibus quotiscunquelibet, minimum numerum eas continentium inuenire.

*[Figure: dotted number lines beside the text: a "tertia" d (3 dots); b "quinta" e (5 dots); c "sexta" f (6 dots); g (long); h (long)]*
