...
*[Figure: square with corners a (top left), b (top right), g (bottom left), f (bottom right); standing on its top side a smaller pentagonal (house-shaped) figure with apex d and base corners c, e]*
...
*[Figure: two rectangles: the first with corners g (top left), e (top right), b (bottom left), f (bottom right); the second, taller and narrower, with corners e (top left), a (top right), d (bottom left), b (bottom right)]*
