...
*[Figure: circle with inscribed equilateral triangle α β γ (α at top, β bottom left, γ bottom right), centre δ, lines β δ and γ δ, and perpendicular δ ε upon β γ]*
...
*[Figure: circle with horizontal chord δ γ (trianguli latus), pentagon side γ α, centre ε with perpendiculars ε ζ and ε η, points β and θ marked; below the circle a separate long horizontal segment labelled θ, the cubi latus]*
