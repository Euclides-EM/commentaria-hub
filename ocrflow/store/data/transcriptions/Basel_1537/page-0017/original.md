...
*[Margin: 1]* Super data recta linea terminata : triangulū æquilaterū constituere.
...
*[Figure: two equal intersecting circles with centres α and β, meeting above in γ; triangle α β γ drawn on the line α β; δ at the left extremity, ε at the right]*

## Euclides ex Campano. Propositio 2.

*[Margin: 2]* *[Decorated initial A]* Dato puncto: cuilibet lineæ rectæ propositæ æquam rectam lineam ducere.
...
*[Figure: two circles, the smaller e b with centre c inside the larger e f with centre d; small triangle a c d at the centre, b at the left on the smaller circle, line d c produced to e below and line d a produced to f at the right]*

## Eucl. ex Zamb. Problema 2. Propositio 2.

*[Margin: 2]* Ad datum signum, datæ rectæ lineæ æquam rectam lineam ponere.
...
*[Figure: two circles, the smaller about β inside the larger about δ; above them the point δ with the equilateral triangle α β δ, the sides produced through α and β to the circumferences, with points γ, η, κ, λ marked on the circles]*
