...
*[Figure: semicircle on the base line a…d with t and g on the arc and c at the apex; e and f at the ends of a horizontal chord; within, the letters i, p, b, b, r, n, q around the centre and K at the middle of the base; a vertical line from c to K]*
...
*[Figure: semicircle on the base line d…a with K, c and e on the arc; within, triangles carrying the letters b, g, b]*
...
*[Figure: b at the upper left, m at the top middle, p at the upper right; below, a semicircle with a at its left; within it the letters b, a, l, K, g, e about the centre; long lines from b and p converge to f at the bottom]*
