...
*[Figure: circle with centre K at its base, apex b above; from b lines descend to the circle; inner circle through the cone with points q, s, r; points n, d at lower left, l, c at lower right]*
...
*[Figure: apex b above a circle; within the circle points d, r, f; below the circle points l, K and a further point at right]*
...
*[Figure: apex a above, with n just below it; larger circle enclosing a smaller one; points q, s, r within, d at left, f at right, b at either side below, k in the lower circle]*
