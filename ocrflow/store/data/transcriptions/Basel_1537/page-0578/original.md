...
*[Figure: a rectangle with a inside, corners b (top left), g (top right), f (bottom left), e (bottom right); beside it a square with d inside and base corners c, b]*
...
*[Figure: a house-shaped (pentagonal) areola with apex k, upper corners x (left) and l (right), points n (left side) and m (right side) below them, and o at the bottom left; horizontal lines divide the figure]*
