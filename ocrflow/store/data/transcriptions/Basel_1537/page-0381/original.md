...
*[Figure: two pyramid-like solid angles: on the left, apex α with edges to β (left) and λ (right) and base points κ and θ joined by crossing lines; on the right, apex δ with edges to γ and ε and base points ζ and η joined by crossing lines]*

## Eucli. ex Camp. Propositio 27.

*[Margin: 27]*

## SVper assignatam lineam, dato solido æquidistantiū superficierū simile solidum constituere.
...
*[Figure: two parallelepipeds: the larger on the left with visible labels a and k at top, b, m at the upper face, n at centre, h at the left, l and p at the bottom; the smaller on the right with labels c, g, f, e, d]*

## Eucli. ex Zamb. Problema 5. Propositio 27.

*[Margin: 27]*

## Ex data recta linea, dato solido parallelepipedo simile & similiter positum solidum parallelepidedum *[sic: for parallelepipedum]* describere.
