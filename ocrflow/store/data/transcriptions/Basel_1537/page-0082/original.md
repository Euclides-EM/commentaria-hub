...
*[Figure: arc of a circle with points c and d on the arc, a at left and b at right; within, the chords a c and b d bisected at e and f, the perpendiculars crossing at k; h and g at the lower ends]*

*[Figure: arc of a circle with c and d on the arc; the horizontal line h e k f g crossed by vertical lines, a and b at the bottom]*

*[Figure: semicircle on the base a c b]*

*[Figure: circle with c at top, centre e, and a, d, b at the bottom, with lines from a to c and from a and b to e]*

*[Figure: portion less than a semicircle: pointed oval a d b with e below the base and a line descending to f]*
...
*[Figure: segment of a circle with β at the top, δ within, α at left, γ at right, with the chord α γ and lines joining the points]*
