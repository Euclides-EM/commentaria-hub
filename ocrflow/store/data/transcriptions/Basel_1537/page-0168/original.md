...
[Diagram: two triangles, the left larger with apex κ and base vertices α, β, the right with apex λ and base vertices γ, δ; between their apexes a short horizontal line labelled ξ]

LEMMA. Quod autem si rectilinea æqualia & similia fuerint similis rationis latera ipsorum æqualia inuicem sunt, sic demonstrabimus, sint æqualia & similia rectilinea ν θ, & σ ρ, sitq́̃; sicut θ η, ad θ ν, sic ρ π ad π σ. Dico quod æqualis est ρ π, ipsi η θ. Si autem inæquales sunt, earum altera maior est, sit maior ρ π, quàm θ η, & quoniam est sicut ρ π, ad π σ, sic θ η, ad η ν, & uicißim quoque (per 16 quinti,) sicut ρ π, ad θ η, sic π σ, ad η ν, maior autem est ρ π. ipsa θ η, maior igitur & π σ, quàm η ν. Quare & ρ σ, maius est ipso θ ν, sed & æquale (per hypothesin, quod est impoßibile, inæqualis igitur minime est π ρ, ipsi θ η, æqualis igitur. Quod demonstrasse oportuit.

[Diagram: a larger square labelled μ on the base ε ζ, and a smaller square labelled ν on the base η θ; below, two short horizontal lines, one labelled ο, and a square labelled σ with base vertices π and ρ]
...
[Diagram: parallelogram with corners a (top left), b (top right), d (bottom left), c (bottom right); k on the top side, b on the bottom side, f on the left side, g on the right side, e at the centre; the diagonal a c, the vertical line through k, and the horizontal line f g are drawn]
...
[Diagram: parallelogram with corners a (top left), b (top right), d (bottom left), e (bottom right); f on the base, k and g on the right side, h and e inside; two lines from a run to the bottom right corner, with a vertical and a horizontal line crossing at the centre]
