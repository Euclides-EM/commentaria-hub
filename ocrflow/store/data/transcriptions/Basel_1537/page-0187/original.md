...
**7** SI fuerint duo numeri quorum unus alterius pars, detrahaturq̃ ab ambobus ipsa pars, erit reliquus tota pars reliqui, quota totus totius.
...
*[Figure: dot diagram: g at top with a diagonal column of single dots descending; then b; then row f (8 dots) with d (4 dots); then a; then row e (5 dots) with c (2 dots)]*
...
*[Figure: dot-rows: η (4 dots) γ (9 dots) ζ (4 dots) δ in one line; α (5 dots) ε (2 dots) β in a second line]*

## Eucli. ex Camp. Propositio 8

**8** SI à duobus numeris (quorum alter alterius partes) propositis partes illæ subtrahātur, erit reliquus reliqui eædem partes quæ est totus totius.
...
*[Figure: dot diagram: b; row f (3 dots) with d (6 dots); a; row e (2 dots) with c (4 dots); row g (2 dots) with k (1 dot); b (2 dots)]*
