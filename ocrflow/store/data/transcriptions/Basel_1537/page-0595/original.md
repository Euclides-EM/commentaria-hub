...
*[Figure: a circle with points b (upper left), a (right), c (left), e (lower left), centre d, with chords a c, a e, c e drawn]*
...
*[Figure: a circle with points a (upper right), b (left), c (lower left), e (bottom), centre d, with chords drawn]*
