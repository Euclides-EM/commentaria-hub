...
*[Figure: the datum circle intersected by circle f e g, letters d, f, h, e along the horizontal diameter, the intersections at g and e; below, the given line a b]*
...
*[Figure: circle α β γ with horizontal diameter β γ, and the circle α ε ζ described about centre γ cutting it; the line γ α drawn; beneath, the given line δ]*
...
*[Figure: tangent line g d h touching at d a circle with inscribed triangle d e f; at the left, the assigned triangle a b c]*
...
*[Figure: tangent line η α θ touching at α a circle with inscribed triangle α β γ; at the left, the given triangle δ ε ζ]*
