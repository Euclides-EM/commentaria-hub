...
*[Figure: semicircular arc with b at the summit; a, d, c on the base chord; lines b a, b d, b c drawn]*
...
*[Figure: arc with δ at the summit; α, γ, β on the base chord; lines α δ, γ δ, δ β drawn]*
...
*[Figure: four circles in a row illustrating the cases: (1) circle with b at top, a and c at the ends of the diameter a d c through centre d, triangle a b c with line b d; (2) circle with triangle a b c and line c b produced to e; (3) circle with portion a b c greater than a semicircle, centre d, diameter a d e, lines b a, b c, e b; (4) circle with e at top, points b, c, d, f, chord and lines for the fourth and fifth parts]*
