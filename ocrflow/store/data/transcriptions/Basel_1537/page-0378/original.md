...
*[Figure: large circle with λ at the top, μ and ν at the left and right of the circumference, and interior points ο (upper centre), π (left), σ and τ (lower left and right) and ξ (bottom), joined by a web of lines forming nested lozenges]*

*[Figure: semicircle on base α β with γ on the arc joined to α and β; a vertical segment marked ξ stands at the left; the letter λ beside α at the baseline]*

## Eucli. ex Camp. Propositio 24

24 *[Decorated initial S]* I superficiebus æquidistātibus solidum contineatur, eius oppositæ superficies sibi inuicē æquales sunt & æquidistantium laterum.
...
*[Figure: parallelepiped in perspective, with a at the lower front left corner and b at the upper back right corner]*
