...
*[Decorated initial S with foliage]* I à duobus punctis aliquam lineā terminantibus, duæ lineę ad punctum unū concurrentes exierint, ab eisdē punctis alias duas lineas singulas suis conterminalibus æquales qui ad alium punctū concurrant, in eandem partem adduci est impossibile.
...
*[Figure: triangle on base a b with two apexes c and d near the top and crossing lines from a and b to both apexes]*

*[Figure: second case: points e and f at the upper left above d, with d above c; lines from a (lower left) and b (lower right) through c and d, the lines b c and b d produced beyond the base to e and f]*
