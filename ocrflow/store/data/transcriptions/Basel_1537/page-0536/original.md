...
*[Woodcut initial C]* CVm oculorum distantia sphæræ diametro maior fuerit hemisphærio, maius id quod ipsius sphæræ spectabitur apparebit.
...
*[Figure: triangle with apex h at top and base corners b and c; circle inscribed with centre κ, touching the sides at d (left) and f (right), n at the top of the circle]*

## Theorema uigesimumseptimum.

*[Woodcut initial S]* SI oculorum interuallū minus fuerit sphæræ diametro, id sphæræ quod spectatur hemisphærio minus spectabitur.
...
*[Figure: the two eyes b (above) and c (below) at left; lines to a circle at right touching it at f (top) and g (bottom); κ at the right of the circle, n inside, h where the lines cross]*

## Theorema uigesimumoctauum.

*[Woodcut initial C]* CYlindro utcunque inspecto ab oculo uno, minus hemicylindro spectabitur.
...
*[Figure: eye n at top; rays descending to a circle below with centre κ; b and c at the ends of the horizontal line through the circle, f on the circle at the right, tangent points on either side]*

## Theorema uigesimumnonum

*[Woodcut initial O with face]* OCulo. propius ad cylindrum posito, minus quidem erit assumptum cylindri sub ipsis aspectibus, uidebitur autem maius aspici.
