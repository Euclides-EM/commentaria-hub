...
*[Figure: circle α β γ δ with centre ε and two perpendicular diameters, circumscribed by the square ζ η θ κ tangent at the four points]*
...
*[Figure: square a b c d with side midpoints f (top), g (left), h (bottom), e (right); lines e g and f h meet at k, centre of the inscribed circle]*
...
*[Figure: square α β γ δ with inscribed circle of centre η touching the sides at ε, ζ, θ, κ]*
...
*[Figure: square a b c d set diagonally, with diagonals meeting at centre e, and circumscribed circle through a, b, c, d]*
