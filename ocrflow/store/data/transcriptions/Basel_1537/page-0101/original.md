...
α, β, γ, δ, excitentur (per 17 tertij) rectæ lineæ tangentes circulum α β γ δ, sintq̃ ζ η, η θ, θ κ, κ ζ. Quoniam igitur recta linea ζ η, ipsum circulum α β γ δ, tangit in signo α, & ab ε, centro in ipsum α, contactum coniungitur recta linea ε α, anguli igitur qui sunt ad α, sunt recti (per 18 tertij) & ob id etiam anguli qui ad β γ δ, signa: sunt recti. Et quoniam angulus α ε β, rectus est, & angulus qui sub ε β η, quoque rectus est: parallelus igitur est η θ, ipsi α γ, (per 28 primi,) & ob id quoque, α γ, ipsi ζ κ, parallelus est. Similiter quoque iam ostendemus, quod & utraque ipsarum ζ η, & θ κ, ipsi β δ, parallelus est, parallelogramma igitur sunt η κ, η γ, α κ, ζ β, & β κ, æqualis igitur est ζ η, ipsi θ κ, & η θ, ipsi ζ κ (per 34 primi. Et quoniam æqualis est α γ, ipsi β δ, sed α γ, utrique ipsarum η θ, & ζ κ, est æqualis, & β δ, utrique ipsarum ζ η, & θ κ, est æqualis utraque igitur ipsarum η θ, & ζ κ, utrique ipsarum ζ η, & θ κ, est æqualis, æquilaterum igitur est ζ η θ κ, quadrilaterum. Dico quod & rectangulum. Quoniam enim parallelogrammum est η β ε α, & angulus α ε β, rectus igitur est & qui sub α η β, est angulus, (per 34 primi, similiter quoque ostendemus quod & qui ad θ κ ζ, anguli consistunt recti sunt. Rectangulum igitur est, ipsum ζ η θ κ, quadrilaterum, demonstratum uero quod & æquilaterum, quadratum igitur est, & circa α β γ δ, circulum: descriptum est. Circa datum igitur circulum, quadratum descriptum est, quod oportebat facere.

[Diagram: circle α β γ δ with centre ε and two perpendicular diameters, circumscribed by the square ζ η θ κ tangent at the four points]
...
[Diagram: square a b c d with side midpoints f (top), g (left), h (bottom), e (right); lines e g and f h meet at k, centre of the inscribed circle]
...
[Diagram: square α β γ δ with inscribed circle of centre η touching the sides at ε, ζ, θ, κ]
...
[Diagram: square a b c d set diagonally, with diagonals meeting at centre e, and circumscribed circle through a, b, c, d]
