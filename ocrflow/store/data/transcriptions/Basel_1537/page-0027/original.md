...
*[Figure: triangle a b c with side b c produced to d and side b a produced to e; labels e, a, d, c, b]*
...
*[Figure: triangle α β γ with side β γ produced to δ]*
...
*[Figure: triangle with vertices a, d, b along the top and c below, line c d drawn within triangle a b c]*
...
*[Figure: triangle α β γ with point δ on side α γ and line β δ drawn; labels α, δ, β, γ]*
...
*[Figure: triangle with labels b at top, c at right, a at bottom left]*
