...
*[Figure: two arcs over the base line d, c, b, meeting at f above; chords from f to d, c, b]*
...
*[Figure: two arcs over the base line d, c, b, meeting at f above; chords from f]*
...
*[Figure: large semicircle with a at its apex, over two smaller semicircles marked f and k; base line with b at the left, c in the middle, b at the right]*
...
*[Figure: two small circle-segments side by side, the first with k at its apex over the base l, f, the second with d(?) at its apex over the base b, b]*

*[Figure: fan of lines converging to m at the bottom; along the top the points b, f, n and z(?); on the descending lines the points d, f, p, r and i, t, k, f]*
