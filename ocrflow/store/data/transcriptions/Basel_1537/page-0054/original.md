...
*[Figure: line α γ β δ along the top; square γ ε ζ δ below segment γ δ; diagonal δ ε; vertical β η cutting the diagonal at θ; horizontal κ λ θ μ (κ below α, μ on δ ζ); ξ on the diagonal near the top right, ο inside below; circle inscribed in the square marking the gnomon]*

## Eucli. ex Camp. Propositio 7.

*[Margin: 7]* SI linea in duas partes diuidatur, quod fit ex ductu totius in seipsam cū eo quod est ex ductu alterius partis in seipsam, æquū est eis quæ ex ductu totius lineæ in eandem partem bis & ex ductu alterius partis in seipsam.
...
*[Figure: square a b d e (b bottom left, a bottom right, e top left, d top right); c on bottom side, f on top side; diagonal b d; vertical c f cutting the diagonal at g; horizontal h g k through g (h on side b e, k on side a d)]*

## Eucli. ex Zamb. Theorema 7. Propositio 7.

*[Margin: 7]* Si recta linea secetur utcunq́ꝫ, & quod ex tota & q̊d ex uno segmentorū utraq́ꝫ quadrata, æqualia sunt rectangulo cōprehenso bis sub tota & dicto segmento, & ei quod à reliquo segmēto fit quadrato.
...
*[Figure: square β α δ ε (β top left, α top right, ε bottom left, δ bottom right); γ on top side; diagonal β δ; vertical from γ through the diagonal; horizontal ζ θ (ζ on side β ε, θ on side α δ) crossing at η; λ inside the upper left square, κ inside right of centre, μ inside the lower left; circle through the pieces marking the gnomon]*
