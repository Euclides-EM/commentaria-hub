...
*[Figure: dot-rows in the right margin, ε (1 dot), α (2 dots), β (4 dots), γ (8 dots), δ (8 dots)]*
...
*[Figure: dot-rows in the right margin, d and e in one row; below, b and c; below, a (2 dots); below, a single dot above the word Vnitas]*
...
*[Figure: dot-rows in the right margin, ζ (1 dot), α (3 dots), β (4 dots), γ (5 dots), δ (12 dots), ε (15 dots)]*
...
*[Figure: dot-rows in the right margin, d and e in one row; below, a (2 dots)]*
...
*[Figure: dot-rows in the right margin beside the annotatio, b (3 dots) and c (4 dots)]*
