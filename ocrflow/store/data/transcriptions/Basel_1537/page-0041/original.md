...
*[Figure: triangles a b c and d e f on equal bases b c and e f between parallels a g and b h, with lines c k and f l drawn; letters a, k, d, l, g above and b, c, e, f, h below]*
...
*[Figure: triangles α β γ and δ ε ζ on equal bases β γ and ε ζ between parallels, with η and θ on the upper parallel and lines β η, ζ θ drawn]*

## Eucli. ex Camp. Propositio 39.

*[Margin: 39]*

Mnes duo trianguli æquales, si in eandem basin & ex eadem parte ceciderint, inter duas lineas æquidistantes erunt.
...
*[Figure: base b c with triangles a b c and d b c on the same side; line through a parallel to b c, points e and f marked where b d produced or cut meets it, with lines e c and f c drawn]*
