...
*[Figure: right triangle with apex α above base line β δ ε, perpendicular drawn from α to δ, with rectangular parallelograms constructed on the sides]*
...
THEON ex Zamberto. Sint bina triangula α β γ,& δ γ ε,duo latera β α, & α γ.duobus lateribus δ γ,& δ ε,proportionalia habentia,sicut quidem α β,ad α γ,sic δ γ,ad δ ε,parallelum autem α β,ipsi δ γ,& α γ,ipsi δ ε. Dico quod in rectam lineam est β γ,ipsi γ ε.Quoniam enim parallelus est α β,ipsi δ γ,& in eas incidit recta linea α γ,anguli igitur (per 29 primi.*utrobiq̃ qui sub β α γ,& α γ δ,sibi inuicem sunt æquales.Id propterea & angulus γ δ ε, angulo α γ δ, est æqualis. Quare angulus β α γ, angulo ε δ γ.est æqualis, & quoniam duo triangula sunt α β γ, δ γ ε,unum angulum qui ad α, uni angulo qui ad δ, æqualem habentia, circum autem æquales angulos latera proportionalia,sicut quidem β α,ad α γ. sic γ δ, ad δ ε, æquiangulum igitur est (per 6 sexti, triangulum α β γ, triangulo δ γ ε. Aequalis igitur est angulus α β γ,angulo δ γ ε,patuit autē quod angulus α γ δ,æquus (per 29 primi) angulo β α γ. Totus igitur angulus α γ ε,duobus α β γ,& β α γ,est æqualis.Communis apponatur angulus α γ β. Igitur anguli α γ ε,& α γ β, eis qui sunt sub γ α β,α γ β. & γ β α,sunt æquales.Sed anguli β α γ,γ β α, & α γ β,(per 32 primi) duobus rectis sunt æquales,& anguli igitur α γ ε, & α γ β,duobus rectis sunt æquales. Ad aliquam autem rectam lineam α γ.ad signū que in ea γ,duæ rectæ lineæ β γ,& γ ε,non ad easdem partes ductæ,æquos *utrobique sub α γ ε,& α γ β,duobus rectis æquales efficiunt angulos,(per 14 primi,)in rectam lineam igitur est β γ,ipsi γ ε.Si bina igitur triangula componantur ad unum angulum,duo latera duabus lateribus proportionalia habentia,ut eorum similis rationis latera etiam parallela sint,reliqua ipsorum triangulorum latera in rectam lineam erunt.Quod demonstrasse oportuit.

*[Margin, at the first asterisk: ἐναλλάξ]*

*[Margin, at the second asterisk: ἐφεξῆς]*
