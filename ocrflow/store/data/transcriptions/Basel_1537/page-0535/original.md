...
*[Figure: large circle with the eye b at top; tangents from b touching a smaller inner circle at l (left) and f (right), with n between them; a second circle below through d, κ, e]*

## Theorema uigesimumquartum.

*[Woodcut initial O with face]* OCulo ad sphæram propius accedēte, spectatum minus est, putabitur autem maius uideri.
...
*[Figure: eye d at top with r below it; tangent lines from d and r to a sphere, a circle centred κ at bottom; smaller circles through the tangent points, with s (left) and f (right) on one, n (left) and l (right) on the other; b and e at the lowest circle]*

## Theorema uigesimumquintum.

*[Woodcut initial S]* SPhæra binis spectata oculis, si dimetiens sphæræ æquus fuerit rectæ lineæ distāti ab oculis, ipsius hemisphærium spectabitur.
