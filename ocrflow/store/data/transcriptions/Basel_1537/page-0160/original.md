...
### SI duo trianguli quorum unus angulus unius uni angulo alterius æqualis,æquales fuerint.latera duos angulos æquos continentia erunt mutekesia.Si uero latera duos æquos angulos cōtinentia fuerint mutekesia,duo trianguli æquales esse comprobantur.
...
*[Figure: two triangles joined at the common point c: a at top left, d at top right, b at bottom left, e at bottom right; the lines a c e and d c b cross at c, and the line b e is drawn]*
...
*[Figure: two triangles joined at the common point α: β at top left, δ at top right, γ at bottom left, ε at bottom right; the lines γ α δ and ε α β cross at α, and the line β δ is drawn]*
