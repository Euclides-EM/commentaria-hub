...
*[Figure: circle with pentagon α β γ δ μ (α at top, β left, γ right, δ lower left, μ lower right) and its diagonals; horizontal diagonal β γ bearing points κ and θ; vertical diameter α ζ through centre ε and point η; horizontal line δ η μ; ζ at the bottom]*
...
*[Figure: circle α β with centre γ; a horizontal radius γ β drawn as a thick segment, cut in extreme and mean ratio at δ; α at the top of the circle]*

*[Figure: three horizontal segments with letters and captions:]*
...
*[The letters ε and η of the table appear exchanged relative to the text, in which η is the cube's side and ε the icosahedron's]*
