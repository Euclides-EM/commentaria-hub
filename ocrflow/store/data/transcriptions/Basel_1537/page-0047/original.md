...
*[Figure: right triangle a b c with a at top and squares on the three sides: f, g on a b, h, k on a c, d, l, e on b c below; m on b c; lines a d, a e, b k, c f drawn]*
...
*[Figure: right triangle α β γ with square β δ ε γ below on β γ, squares η β on α β and θ γ on α γ above, line α λ parallel to β δ and γ ε, lines α δ, ζ γ, α ε, β κ drawn]*
