...
*[Margin: 9]* Datum angulum rectilineum, bifariam secare.
...
*[Figure: angle at α opening downwards to β and γ; points δ and ε on the two legs, the line δ ε drawn, the equilateral triangle δ ζ ε below it with ζ at the bottom, and the bisecting line α ζ]*

## Eucli. ex Camp. Propositio 10.

*[Margin: 10]* *[Decorated initial P]* Roposita recta linea: eam per æqualia diuidere.
...
*[Figure: equilateral triangle with apex c above the base a b; the line c d drawn from the apex to the midpoint d of the base]*

## Euclides ex Zamb. Problema 5. Propositio 10.

*[Margin: 10]* Datam rectam lineam terminatam: bifariam secare.
...
*[Figure: equilateral triangle with apex γ above the base α β; the line γ δ drawn from the apex to the midpoint δ of the base]*

## Eucli. ex Camp. Propositio 11.

*[Margin: 11]* *[Decorated initial D with foliage]* Ata linea recta, à puncto in ea signato perpendicularem extrahere: duobus quidem angulis æqualibus ac rectis utrinque subnixam.
...
*[Figure: triangle with apex d above; base line a b with the point c between a and b, and the perpendicular line d c drawn from the apex to c]*

## Eucli. ex Zamb. Problema 6. Propositio 11.

*[Margin: 11]* Data recta linea, à signo in ea dato rectā lineā ad angulos rectos excitare.
