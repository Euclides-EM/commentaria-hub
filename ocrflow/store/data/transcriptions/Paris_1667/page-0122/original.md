...
## SECONDE SECTION. DE LA LIGNE CIRCVLAIRE.
...
Les lignes menées d'un point de la circonference à un autre s'appellent *cordes*.
...
Si elles paſſent par le centre, elles s'appellent *diametres*, & elles coupent le cercle & la circonference en deux parties égales, qui s'appellent *demycercles* & *demycirconferences*.
...
Chaque degré en 60 minutes premieres qu'on appelle ſimplement *minutes* : Chaque minute en 60 *ſecondes*, & chaque ſeconde en 60 *troiſièmes* ; & ainſi à l'infini.
