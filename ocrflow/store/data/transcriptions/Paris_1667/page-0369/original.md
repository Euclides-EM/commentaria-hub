...
CEtte methode conſiſte en fort peu de regles ; les unes generales, les autres particulieres, ſelon leſquelles il faut tranſpoſer les chiffres du quarré naturel dans le magique.
...
QUand on a placé un *petit* chiffre dans un coin, il faut placer ſon *grand* dans le coin diagonalement oppoſé.
...
HOrs les coins il faut placer les grands vis à vis des petits de la bande oppoſée.

C'eſtpourquoy il faut obſerver de ne mettre jamais deux petits en des bandes oppoſées vis à vis l'un de l'autre.
...
Il s'enſuit, 1. Que les chiffres de deux bandes oppoſées pris enſemble, valent autant de fois *c* qu'il y a de chiffres
