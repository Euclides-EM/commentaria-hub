...
func (m *Model) List() ([]*ocrflow.Model, error) {
...
func (m *Model) Get(id string) (*ocrflow.Model, error) {
...
func (m *Model) Create(mo *ocrflow.Model, modelPath string) error {
	var n *ocrflow.Model
	...
	n.Location = ocrflow.OCRModelLocationLocal
...
func (m *Model) Upload(file multipart.File, filename, name, description string, baseAnnotations []*ocrflow.AnnotationReference, baseModelID string) (*ocrflow.Model, error) {
	if filename == "" {
...
func (m *Model) Update(id string, mo *ocrflow.Model) (any, error) {
