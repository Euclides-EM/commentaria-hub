...
func (d *Dataset) List(filter *querylang.Filter, sort querylang.Sort) ([]*ocrflow.Dataset, error) {
...
func (d *Dataset) Get(id string) (*ocrflow.Dataset, error) {
...
func (d *Dataset) Create(ctx context.Context, ds *ocrflow.Dataset, forceOverwrite, skipDeskew bool) (*ocrflow.Dataset, error) {
...
func (d *Dataset) ListSuggestedAnnotationReview(id string) ([][]*ocrflow.AnnotationExpectedBlocks, error) {
	return [][]*ocrflow.AnnotationExpectedBlocks{
		{
			{
				Category: "MainZone-Head--Book",
				SanityChecks: []ocrflow.AnnotationExpectedBlocksSanityType{
					ocrflow.AnnotationExpectedBlocksSanityTypeExact,
				},
...
func (d *Dataset) Update(id string, m *ocrflow.Dataset) (*ocrflow.Dataset, error) {
