...
func (a *AnnotationRuleApplier) ApplyRules(imgPath string, ann *ocrflow.Annotation, rules []annotationrule.AnnotationRule) error {
	var err error
...
func (a *AnnotationRuleApplier) ApplyRule(imgPath string, ann *ocrflow.Annotation, rule annotationrule.AnnotationRule) (*ocrflow.Annotation, error) {
...
func (a *AnnotationRuleApplier) applySlicePagesRule(ann *ocrflow.Annotation, t *annotationrule.SlicePages) (*ocrflow.Annotation, error) {
...
func (a *AnnotationRuleApplier) applyTextBlockCorrection(ann *ocrflow.Annotation, t *annotationrule.TextBlockCorrections) (*ocrflow.Annotation, error) {
...
func (a *AnnotationRuleApplier) applyLinesDetectRule(imgPath string, ann *ocrflow.Annotation, t *annotationrule.LinesDetect) (*ocrflow.Annotation, error) {
...
func (a *AnnotationRuleApplier) applySegment(imgPath string, ann *ocrflow.Annotation, t *annotationrule.Segment) (*ocrflow.Annotation, error) {
	...
	case ocrflow.OCRModelLocationLocal:
	...
	case ocrflow.OCRModelLocationRoboflow:
		f = func() (<-chan error, error) {
...
func (a *AnnotationRuleApplier) applyDetectText(imgPath string, ann *ocrflow.Annotation, t *annotationrule.DetectText) (*ocrflow.Annotation, error) {
