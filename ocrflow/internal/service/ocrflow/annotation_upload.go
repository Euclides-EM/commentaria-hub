...
func (a *AnnotationsUploader) UploadToRoboflow(datasetID string, id string, rbu *ocrflow.AnnotationUploadRoboflow) (*ocrflow.Annotation, error) {
...
func (a *AnnotationsUploader) UploadToEscriptorium(datasetID string, id string, aue *ocrflow.AnnotationUploadEscriptorium) (*ocrflow.Annotation, error) {
	ann, err := a.annotationSvc.Get(datasetID, id)
	if err != nil {
		return nil, fmt.Errorf("annotation not found: %w", err)
	}
...
func (a *AnnotationsUploader) convertAlto2Yolo(datasetID string, id string) (*ocrflow.Annotation, error) {
	ann, err := a.annotationSvc.Get(datasetID, id)
	if err != nil {
		return nil, fmt.Errorf("annotation not found: %w", err)
	}
