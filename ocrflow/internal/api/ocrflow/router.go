...
import (
	...
	_ "github.com/MiaMish/elements-dh/ocrflow/internal/docs/ocrflow"
...
type Dependencies struct {
	...
	HealthSvc           *ofservice.Health
	EditionSvc          *ofservice.Edition
	DatasetSvc          *ofservice.Dataset
	AnnotationSvc       *ofservice.Annotation
	ModelSvc            *ofservice.Model
	TrainSvc            *ofservice.Train
	MetadataDetailsSvc  *ofservice.MetadataDetails
	MetaStoreManager    *ofservice.MetaStoreManager
	AnnotationsUploader *ofservice.AnnotationsUploader
	AnnotationTEI       *ofservice.AnnotationTEI
	AssetGen            *ofservice.AssetGen
	AnnotationSearch    *ofservice.AnnotationSearch
}
