...
func (h *Handlers) ListEditions(r *http.Request) (any, error) {
	return h.deps.EditionSvc.ListEditions(ocrflow.ToEditionExpandOptions(r.URL.Query().Get("expand")), ocrflow.ToEditionOrderByOptions("orderBy"))
}
...
func (h *Handlers) CreateEdition(r *http.Request) (any, error) {
	var ed ocrflow.Edition
	if err := common.DecodeBody(r, &ed); err != nil {
		return nil, err
	}
