...
func (h *Handlers) CreateAnnotation(r *http.Request) (any, error) {
	...
	var a ocrflow.Annotation
	if err = common.DecodeBody(r, &a); err != nil {
		return nil, err
	}
...
func (h *Handlers) DuplicateAnnotation(r *http.Request) (any, error) {
	...
	var req ocrflow.AnnotationDuplicateRequest
	if err = common.DecodeBody(r, &req); err != nil {
		return nil, err
	}
...
func (h *Handlers) UploadToRoboflow(r *http.Request) (any, error) {
	...
	var urb ocrflow.AnnotationUploadRoboflow
	if err = common.DecodeBody(r, &urb); err != nil {
		return nil, err
	}
...
func (h *Handlers) UploadToEscriptorium(r *http.Request) (any, error) {
	...
	var aue ocrflow.AnnotationUploadEscriptorium
	if err = common.DecodeBody(r, &aue); err != nil {
		return nil, err
	}
...
func (h *Handlers) GetAnnotationZipFile(r *http.Request) (any, error) {
	...
	format := ocrflow.AnnotationFormat(strings.ToLower(strings.TrimSpace(r.FormValue("format"))))
	if format != ocrflow.AnnotationFormatAlto && format != ocrflow.AnnotationFormatYolo {
		return nil, fmt.Errorf("unsupported annotation format: %s", format)
	}
	aum := &ocrflow.AnnotationUploadMetadata{
		DatasetID:          datasetID,
		Format:             format,
