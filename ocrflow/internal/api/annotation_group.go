...
// @Router        /annotation_groups/{groupId} [get]
...
// @Tags         Annotation Groups
// @Param        group       body      annotation.Group  true  "Annotation Group data"
// @Produce      json
// @Success      200  {object}  annotation.Group
// @Security 	 BearerAuth
// @Router        /annotation_groups [post]
...
// @Tags         Annotation Groups
// @Param        groupId     path      string  true  "Annotation Group ID"
// @Param        group       body      annotation.Group true  "Updated Annotation Group data"
// @Produce      json
// @Success      200  {object}  annotation.Group
// @Failure      404  {string}  string "Not Found"
// @Security 	 BearerAuth
// @Router        /annotation_groups/{groupId} [put]
...
// @Failure      404  {string}  string "Not Found"
// @Security 	 BearerAuth
// @Router        /annotation_groups/{groupId} [delete]
