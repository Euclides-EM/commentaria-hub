...
export type { annotation_Group } from './models/annotation_Group';
...
export type { annotation_MergedReference } from './models/annotation_MergedReference';
...
export type { annotation_TranscriptionFallback } from './models/annotation_TranscriptionFallback';
export type { annotation_TranscriptionFormat } from './models/annotation_TranscriptionFormat';
export type { annotation_TranscriptionLevel } from './models/annotation_TranscriptionLevel';
...
export type { common_ALTOLocation } from './models/common_ALTOLocation';
export type { common_ALTOPart } from './models/common_ALTOPart';
...
export type { common_LogTail } from './models/common_LogTail';
export type { common_OCRModelType } from './models/common_OCRModelType';
export type { feature_AIProvider } from './models/feature_AIProvider';
...
export type { feature_ScopeType } from './models/feature_ScopeType';
export type { job_Job } from './models/job_Job';
export type { job_Jobs } from './models/job_Jobs';
export type { job_Platform } from './models/job_Platform';
...
export type { model_EditionShelfmarkStructuralMetadataAvailability } from './models/model_EditionShelfmarkStructuralMetadataAvailability';
export type { model_EditionShelfmarkTranscriptionAvailability } from './models/model_EditionShelfmarkTranscriptionAvailability';
...
export type { model_FacsimileConnectionConfirmationStatus } from './models/model_FacsimileConnectionConfirmationStatus';
...
export type { model_ReprintDetection } from './models/model_ReprintDetection';
export type { model_ReprintRelationship } from './models/model_ReprintRelationship';
...
export { AnnotationGroupsService } from './services/AnnotationGroupsService';
...
export { EditionFeatureRevisionsService } from './services/EditionFeatureRevisionsService';
export { EditionFeaturesService } from './services/EditionFeaturesService';
...
export { ShelfmarksService } from './services/ShelfmarksService';
export { StoreService } from './services/StoreService';
export { ThirdPartyCatalogsService } from './services/ThirdPartyCatalogsService';
export { TranscriptionsService } from './services/TranscriptionsService';
