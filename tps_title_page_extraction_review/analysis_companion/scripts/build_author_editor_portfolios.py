...
ELEMENTS_META = ROOT.parents[1] / "ocrflow" / "store" / "items_metadata" / "metadata_elements_print.csv"
...
def main() -> None:
    ...
    write_csv(DERIVED / "author_editor_portfolio_case_matrix.csv", case_rows, case_fields)
    write_csv(DERIVED / "author_editor_portfolio_person_summary.csv", person_summary, summary_fields)
    write_csv(DERIVED / "author_editor_portfolio_raw_combo_summary.csv", combo_summary, summary_fields)
    write_csv(DERIVED / "author_editor_portfolio_interesting_people.csv", interesting, interesting_fields)
    write_csv(DERIVED / "author_editor_portfolio_elements_non_elements_pairs.csv", pair_rows, pair_fields)
