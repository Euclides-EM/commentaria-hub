...
def main() -> None:
    ...
    pd.DataFrame(overlap_rows).to_csv(TABLES / "report_bridge_case_route_overlap_matrix.csv", index=False)
    ...
    matrix.to_csv(TABLES / "report_bridge_case_route_marker_rates_matrix.csv")
    heatmap_cols = [
        "canonical/textual",
        "ancient/restoration",
        "method/demo/order",
