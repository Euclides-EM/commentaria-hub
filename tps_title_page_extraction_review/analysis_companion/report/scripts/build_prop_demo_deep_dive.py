...
def main() -> None:
    ...
    for group_col, min_den in [
        ...
        long.to_csv(TABLES / f"report_prop_demo_motifs_by_{group_col}_long.csv", index=False)
        pivot_rates(long).to_csv(TABLES / f"report_prop_demo_motifs_by_{group_col}_matrix.csv")
